...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "border-input bg-card flex h-11 w-full items-center justify-between gap-2 rounded-xl border px-4 py-2 text-sm whitespace-nowrap shadow-xs outline-none",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        position={position}
        className={cn(
          "bg-popover text-popover-foreground relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-xl border border-border/70 shadow-soft-lg",
